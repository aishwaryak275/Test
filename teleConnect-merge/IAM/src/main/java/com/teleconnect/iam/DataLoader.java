...
public class DataLoader implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        List<String> permNames = List.of(
            ...
            "VIEW_NOTIFICATIONS","MARK_NOTIFICATION"
        );
        ...
        createRole("CS",  perms.apply(new String[]{"VIEW_SUBSCRIBER", "CREATE_FAULT_TICKET", "UPDATE_FAULT_TICKET","USAGE_RECORDS","USAGE_ANALYTICS","VIEW_KYC","VIEW_PLAN","CREATE_SUB","GET_SUB","VIEW_NOTIFICATIONS"}));
        ...
        createRole("N",   perms.apply(new String[]{"VIEW_NETWORK_FAULTS", "CLOSE_FAULT_TICKET","USAGE_ANALYTICS","VIEW_PLAN","VIEW_NOTIFICATIONS"}));
        ...
        createRole("A",   perms.apply(new String[]{"CREATE_USER", "DELETE_USER", "MANAGE_PLANS", "VIEW_ALL_USERS", "USAGE_RECORDS","USAGE_ANALYTICS","VIEW_SUBSCRIBER","VIEW_KYC","KYC_EXPIRE","VIEW_PLAN",
                                                           ...
                                                           "PAY_BILL","BILLING_DISPUTE","EDIT_DISPUTE","CREATE_NOTIFICATION","VIEW_NOTIFICATIONS"}));
