...
public class NetworkUtilisationResponse {
    ...
    public void setAvgDataPerSubscriberMb(double avgDataPerSubscriberMb) { this.avgDataPerSubscriberMb =
            avgDataPerSubscriberMb; }

    public double getAvgVoicePerSubscriberMin() { return avgVoicePerSubscriberMin; }
    public void setAvgVoicePerSubscriberMin(double avgVoicePerSubscriberMin) { this.avgVoicePerSubscriberMin =
            avgVoicePerSubscriberMin; }
}
