...
public class SLAComplianceResponse {
    ...
    public void setOverallComplianceRate(double overallComplianceRate) { this.overallComplianceRate =
            overallComplianceRate; }

    public Map<String, PriorityStats> getStatsByPriority() { return statsByPriority; }
    public void setStatsByPriority(Map<String, PriorityStats> statsByPriority) { this.statsByPriority =
            statsByPriority; }
