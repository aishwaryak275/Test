...
public class CollectionEfficiencyResponse {
    ...
    public void setCollectionEfficiencyPct(double collectionEfficiencyPct) { this.collectionEfficiencyPct =
    ...
    public void setOverdueAmount31to60(BigDecimal overdueAmount31to60) { this.overdueAmount31to60 =
            overdueAmount31to60; }

    public BigDecimal getOverdueAmount60plus() { return overdueAmount60plus; }
    public void setOverdueAmount60plus(BigDecimal overdueAmount60plus) { this.overdueAmount60plus =
            overdueAmount60plus; }
}
